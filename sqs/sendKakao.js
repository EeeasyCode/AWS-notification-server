...
module.exports.handler = (event) => {
  try {
    ...
    if (body.MessageAttributes.kakaoType.Value === "공정 완료") {
      messageService
        .sendOne({
          to: userPhone,
          from: "",
    ...
    } else if (body.MessageAttributes.kakaoType.Value === "업체 선정 완료") {
      messageService
        .sendOne({
          to: userPhone,
          from: "",
        ...
        .then((res) => console.log(res));
    } else if (body.MessageAttributes.kakaoType.Value === "신청 완료") {
      messageService
        .sendOne({
          to: userPhone,
          from: "",
